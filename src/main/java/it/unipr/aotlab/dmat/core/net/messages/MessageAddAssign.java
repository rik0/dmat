...
public class MessageAddAssign extends MessageBinaryOp {
    public MessageAddAssign(OrderBinaryOpBody.Builder builder) {
        super(builder);
    }

    protected MessageAddAssign(OrderBinaryOpBody body) {
        super(body);
    }
